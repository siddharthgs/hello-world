...
contractEconomics = pd.DataFrame()
newData = []
...
#contractEconomics = df[['instType','instId','volCcy24h','vol24h','askPx','askSz','bidPx','bidSz']]


#Exporting dataframe to excel 
#df.to_excel("/Users/siddharthdesai/documents/dataAnalysis/OKXinstrumentData.xlsx")
